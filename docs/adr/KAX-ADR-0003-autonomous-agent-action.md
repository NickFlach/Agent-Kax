...
- **Conflict between agents.** Two residents granted overlapping paths will eventually edit the same file. Worktrees make this a merge conflict rather than corruption, but nothing yet decides who yields.
