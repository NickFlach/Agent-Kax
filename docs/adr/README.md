...
| [KAX-ADR-0005](KAX-ADR-0005-ghost-signals-tower.md) | Ghost Signals Tower | Accepted (2026-08-22) | Leasing tower floors to third-party open-source applications — tenancy without deployment, floor-scoped credentials and capabilities, play-credit rent now and gateway money later |
